...
class Trivia {
    ...
    let questionsArray: [TriviaQuestion] = [
        ...
        TriviaQuestion(question: "Who is the best player in the world right now?", option1: "Kevin Durant", option2: "Stephen Curry", option3: "Lebron James", option4: "No answer")
    ]
}
